...
Public Class disbursementbyday2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TagumBuildersSys.disbursementbyday2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheddisbursementbyday2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As disbursementbyday2 = New disbursementbyday2()
        rpt.Site = Me.Site
        Return rpt
    End Function
